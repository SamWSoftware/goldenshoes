...
class FBChatWidget extends Component {
  componentDidMount() {
    var t = {
      delay: 125,
      overlay: $(".fb-overlay"),
    ...
    return (
      <div className="fb-livechat">
        ...
        <div className="fb-widget">
          ...
          <div
            className="fb-page"
            data-href={`https://www.facebook.com/${this.props.pageName}/`}
            data-tabs="messages"
            data-width="360"
            data-height="400"
          ...
          >
            <blockquote
              cite={`https://www.facebook.com/${this.props.pageName}/`}
        ...
        <a
          href={`https://m.me/${this.props.pageName}`}
